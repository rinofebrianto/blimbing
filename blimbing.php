...
echo color("red","| Script Terbuat Dari Hati Yang Tersakiti, Hehe!! Cookk!! |\n");
echo color("green","| Rino Febrianto |\n");
echo color("blue","| IG: mon_yk_|\n");
echo color("yellow","| Creator : Rino Febrianto x Musdarifa Dewi         |\n");
echo "| Pesenku Siji, Lek Wes Penak Ojok Lalk Koncone Cokk!!       |\n";
